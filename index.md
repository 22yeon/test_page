...
**기술 스택:** Touchdesigner, Arduino
 ...
  체험적인 작품을 접할 때, 종종 관객들은 작업의 내용 대신 그 속에 비친 자신을 집중하여 관찰하곤 한다. 왜 우리는 작품 속 자신에 집중하게 될까? 이는 혼란스러운 작품 속 익숙한 것이 자신의 얼굴뿐이라서 그럴 수도 있고, 반대로 새롭게 보이는 자신의 모습에 대한 호기심일수도 있겠다. 다른 체험적인 작업들은 작품의 메시지를 전달하기 위해 관객 자신의 얼굴이나 실루엣에 집중하게 되는 상황을 막았다면, 이 작업은 반대로 스스로를 관찰할 수 있는 장소로 열어두었다. 이 작업을 통해 나는 자신의 얼굴을 조각조각 나눠 기존과는 다른 방식으로 자세하게 살펴 볼 수 있게 하는 동시에, 혼란스러운 조각 속에서도 자신의 얼굴을 인식할 수 있는지 실험하고자 한다.
